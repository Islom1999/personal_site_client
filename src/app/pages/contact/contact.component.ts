          ...
          <div class="space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div class="space-y-4">
                <a
                  href="#"
                  class="flex items-center space-x-4 p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 group"
                >
                  <div
                ...
                >
                  <div
                    class="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center group-hover:bg-red-200 transition-colors duration-200"
                  >
                ...
                >
                  <div
                    class="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center group-hover:bg-pink-200 transition-colors duration-200"
                  >
            ...
            <div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white">
              ...
              <p class="text-blue-100 mb-6">
                Shaxsiy darslar yoki kurslar haqida tezkor ma'lumot olish uchun to'g'ridan-to'g'ri
                qo'ng'iroq qiling
              </p>
              <p-button
