...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ButtonModule, CardModule, TagModule, ProgressBarModule, RatingModule, FormsModule],
  template: `
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Matematik fanlarni chuqur o'rganish uchun professional video kurslar. 
            Har bir mavzu bo'yicha step-by-step ta'lim olish imkoniyati
          </p>
        </div>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl p-8 mb-12 text-white">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <h2 class="text-3xl font-bold mb-4">Matematik Analiz: Noldan Professionallik Darajasigacha</h2>
            ...
            <div class="relative">
              <div class="w-full h-64 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-sm">
        ...
        <div class="mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div *ngFor="let course of courses" 
              ...
              <!-- Course Image -->
              <div class="relative h-48 bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center">
                <div class="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
...
export class CoursesComponent {
  ...
  courses: Course[] = [
    ...
    },
    {
      ...
      description: 'Aniq va noaniq integrallar, ularning hisoblash usullari va amaliy qo\'llanilishi.',
      instructor: 'Prof. Matematik',
      duration: '22 soat',
      lessons: 44,
      level: 'Yuqori',
