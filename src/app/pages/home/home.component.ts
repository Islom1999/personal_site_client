        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="text-center lg:text-left">
            ...
            <p class="text-xl text-gray-600 mb-8 leading-relaxed">
              ...
              Sifatli ta'lim materiallari, interaktiv kurslar va amaliy testlar orqali bilimingizni oshiring.
            </p>
          ...
          <div class="relative">
            <div class="w-full h-96 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-3xl flex items-center justify-center shadow-2xl">
              <div class="text-center">
                <div class="w-32 h-32 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center mb-6 mx-auto shadow-lg">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Ko'p yillik tajriba va zamonaviy o'qitish metodlari bilan matematikani oson va qiziqarli qilib o'rgatamiz
          </p>
        </div>
        
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="relative">
            <div class="w-full h-96 bg-gradient-to-br from-gray-100 to-gray-200 rounded-3xl flex items-center justify-center shadow-xl">
              <div class="text-center">
                <div class="w-40 h-40 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-full flex items-center justify-center mb-6 mx-auto shadow-lg">
            ...
            <div class="space-y-6">
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Oliy matematika, algebra va geometriya bo'yicha chuqur bilim</p>
                </div>
              </div>
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Muvaffaqiyatli o'qitilgan va imtihonlarga tayyorlangan talabalar</p>
                </div>
              </div>
              <div class="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p class="text-gray-600">Talabalarning 95% dan ortig'i imtihonlardan yuqori baholar oladi</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group">
            ...
            <p class="text-gray-600 mb-6">Barcha mavzular bo'yicha to'liq darslik materiallari va qo'llanmalar</p>
            <p-button 
              label="Ko'rish" 
              [text]="true"
          ...
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center group">
            ...
            <p class="text-gray-600 mb-6">Bilimingizni sinab ko'rish uchun mavzulashtirilgan testlar</p>
            <p-button 
              label="Sinash" 
              [text]="true"
              routerLink="/tests"
