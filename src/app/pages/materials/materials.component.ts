...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ButtonModule, CardModule, InputTextModule, SelectModule, FormsModule],
  styles: [
    `
      @import 'tailwindcss';
    `,
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Matematika fanining barcha bo'limlari bo'yicha to'liq darslik materiallari, qo'llanmalar
            va amaliy mashqlar to'plami
          </p>
        </div>
  ...
  materials: Material[] = [
    {
      ...
      description:
        "Vektorlar, matritsalar va chiziqli tenglamalar sistemasi bo'yicha to'liq qo'llanma. Nazariy qism va amaliy misollar bilan.",
      category: 'algebra',
      level: 'orta',
      downloadCount: 1250,
      fileSize: '2.5 MB',
    ...
    },
    {
      ...
      description:
        "Tekislik geometriyasining barcha asosiy formulalari va teoremalar. Uchburchak, to'rtburchak va aylana masalalari.",
      category: 'geometriya',
      level: 'boshlangich',
      downloadCount: 980,
      fileSize: '1.8 MB',
    ...
    },
    {
      ...
      description:
        "Matematik analizning asosiy tushunchalari: hosilalar, integrallar va ularning qo'llanilishi.",
      category: 'analiz',
      level: 'yuqori',
      downloadCount: 756,
      fileSize: '3.2 MB',
    ...
    },
    {
      ...
      description:
        "Kombinatorika asoslari, ehtimollar nazariyasi va statistik hisoblashlar bo'yicha amaliy qo'llanma.",
      category: 'ehtimollar',
      level: 'orta',
      downloadCount: 642,
      fileSize: '2.1 MB',
    ...
    },
    {
      ...
      description:
        "Diskret matematikaning muhim bo'limi - graflar nazariyasi. Algoritm va dasturlash masalalari.",
      category: 'diskret',
      level: 'ilgor',
      downloadCount: 423,
      fileSize: '2.8 MB',
    ...
    },
    {
      ...
      description:
        "Kvadrat tenglamalar va ularning yechimlari. Diskriminant, Vieta teoremalari va amaliy qo'llanish.",
      category: 'algebra',
      level: 'boshlangich',
      downloadCount: 1456,
      fileSize: '1.5 MB',
