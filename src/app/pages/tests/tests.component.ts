...
@Component({
  selector: 'app-tests',
  standalone: true,
  imports: [CommonModule, ButtonModule, CardModule, TagModule, ProgressBarModule, DialogModule, RadioButtonModule, FormsModule],
  template: `
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
          ...
          <p class="text-xl text-gray-600 max-w-3xl mx-auto">
            Bilimingizni sinab ko'ring va matematik ko'nikmalaringizni rivojlantiring. 
            Har xil darajadagi testlar orqali o'z darajangizni aniqlang
          </p>
        </div>
        ...
        <div class="mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div *ngFor="let category of testCategories" 
                 class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group">
              <div class="flex items-center justify-between mb-4">
                <div [class]="'w-12 h-12 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 ' + category.bgColor">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div *ngFor="let test of tests" 
              ...
              <div class="p-6">
                <!-- Test Header -->
                <div class="flex items-center justify-between mb-4">
                  <div [class]="'w-12 h-12 rounded-xl flex items-center justify-center ' + test.color">
        ...
        <p-dialog 
          ...
          <div class="py-4" *ngIf="selectedTest && currentQuestion">
            ...
            <div class="flex items-center justify-between">
              ...
              <p-button 
                [label]="currentQuestionIndex === selectedTest.questions - 1 ? 'Yakunlash' : 'Keyingi'" 
                [icon]="currentQuestionIndex === selectedTest.questions - 1 ? 'pi pi-check' : 'pi pi-chevron-right'"
